...
from src.fairness.with_influence import evaluate_patterns, pattern_to_readable, print_pattern_table
...
top_patterns = evaluate_patterns(X_train_raw, min_support=0.05, top_k=5, max_predicates=2)
