...
from fairness.no_influence import compute_fairness_metrics  # our new combined function
...
no_influence, influence = compute_fairness_metrics(df, target_col=target_col, sens_cols=sens_cols, model=model, positive_class=positive_class, influence_group_col=influence_group_col, positive_group=positive_group, 
                                   test_size=0.2, random_state=912, frac=0.05, dpd_tol=0.1, eod_tol=0.1, ppv_tol=0.1, influence_tol=0.05)
